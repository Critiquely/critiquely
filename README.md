...
3. Run the CLI:
   ```bash
   uv run critiquely --repo_url https://github.com/Critiquely/critiquely.git --original_pr_url https://github.com/Critiquely/critiquely/pull/31 --branch main --modified_files '[{"filename":"processor/src/main.py", "type":"modified","lines_changed":[10,11,32,33,34,35]},{"filename":"processor/src/core/nodes.py", "type":"modified","lines_changed":[10]}]'
   ```
